...
<body>
    ...
    <div class="row w-100">
        ...
        <div class="col border border-top-0 border-bottom-0 border-end-0 pt-3 px-5 pb-5">
            <div class="mb-2 fs-6"><a href="main.php" class="btn text-primary">Kategori</a>/<a href="create.php" class="btn text-primary">Tambah</a></div>
            <div class="h2 mb-3"> Tambah Kategori Berita</div>
            <form action="" method="POST" class="border borde-1 px-3 py-3">
                <div class="">
                    <span>Kategori</span><br>
                    <input type="text" class="form-control mt-2" placeholder="Katergori" name="kategori">
                </div>
                <div class="pt-3">
