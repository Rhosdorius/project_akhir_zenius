        ...
        <div class="col border border-top-0 border-bottom-0 border-end-0 pt-3 px-5 pb-5">
            ...
            <form action="" method="GET" class="mb-4">
                <div class="d-flex justify-content-center mt-1 container">
                    ...
                    <select class="form-select me-4 form-control" name="kategori">
            ...
            <div class="me-5 justify-content-center">
                <div class="ms-5" style="width: 80% ;">
                    <a href="create.php"><button class="btn btn-success">Tambah Artikel Berita</button></a>
                </div>
                <?php
                foreach ($query as $datas) : ?>
                    <div class="card ms-5 mb-5 mt-4" style="width: 75% ;">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item fs-6 text-success"><a href="show.php?id=<?php echo $datas['id'] ?>" class="link text-danger">Tampil</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="update.php?id=<?php echo $datas['id'] ?>" class="link text-danger">Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="delete.php?id=<?php echo $datas['id'] ?>" class="link text-danger">Hapus</a></li>
                        </ul>
                    </div>
                <?php endforeach ?>
            </div>
